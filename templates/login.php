...
>
  <head>
    ...
    <title>Login | SalesTracker</title>
          ...
          <div class="card">
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="http://localhost/gs_code/gs_kadai10/index.php" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Sales Tracker</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Sales Tracker! 👋</h4>
              <p class="mb-4">Please sign-in to your account and start the adventure</p>

              <form id="formAuthentication" class="mb-3" action="http://localhost/gs_code/gs_kadai10/acts/login_act.php" method="POST">
                <div class="mb-3">
    ...
    <div class="wrapper-form d-flex align-items-center">
        <div class="container">
            <div class="row">
                <div class="col-4"></div>
                <div class="col-4">
                    <form action="http://localhost/gs_code/gs_kadai10/acts/login_act.php" method="post">
                        <div class="mb-3">
