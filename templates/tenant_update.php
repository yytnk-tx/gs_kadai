            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tenants/</span> Tenant Update</h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Tenant Update Form</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="http://localhost/gs_code/gs_kadai10/acts/tenant_update_act.php" method="post">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="tenantId" name="tenantId"
                                                    readonly="readonly" value="<?= $tenantId ?>"/>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="tenantName">Tenant Name</label>
                                                <input type="text" class="form-control" id="tenantName" name="tenantName" placeholder="ACME Inc."
                                                    value="<?= $tenantName ?>"/>
                                            </div>
                                            ...
                                            <a href="http://localhost/gs_code/gs_kadai10/tenant_list.php" class="btn btn-secondary">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-4">
                    ...
                    <form action="http://localhost/gs_code/gs_kadai10/acts/tenant_update_act.php" method="post">
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="http://localhost/gs_code/gs_kadai10/tenant_list.php" class="btn btn-secondary">キャンセル</a>
                        </div>
                    </form>
                </div>
                <div class="col-4"></div>
