...
<head>
    ...
    <title>TenantRegist | Sales Tracker</title>
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Tenants/</span> Tenant Regist</h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Tenant Regist Form</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="http://localhost/gs_code/gs_kadai10/acts/tenant_regist_act.php" method="post">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="tenantId" name="tenantId" placeholder="0000000"
                                                    value="<?= isset($original['tenantId']) ? $original['tenantId'] : null; ?>"/>
                                                <div class="form-text">You can use 7 digit numbers</div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="tenantName" name="tenantName" placeholder="ACME Inc."
                                                    value="<?= isset($original['tenantName']) ? $original['tenantName'] : null; ?>"/>
                                            </div>
