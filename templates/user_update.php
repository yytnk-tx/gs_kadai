        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Users/</span> User Update</h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">User Update Form</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="http://localhost/gs_code/gs_kadai10/acts/user_update_act.php" method="post">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" id="userName" name="userName" value="<?= $updateUserName ?>"/>
                                            </div>
                                            ...
                                            <?php if(isSystemAdministrator()) : ?>
                                                <div class="mb-3">
                                                    <label class="form-label" for="userTenant">User Tenant</label>
                                                    <select class="form-select" name="userTenant" id="userTenant">
                                                        <?= $tenantSelectView ?>  
                                                    </select>
                                            ...
                                            <a href="http://localhost/gs_code/gs_kadai10/user_list.php" class="btn btn-secondary">Cancel</a>
                                        </form>
                                    </div>
                                </div>
                            </div>
