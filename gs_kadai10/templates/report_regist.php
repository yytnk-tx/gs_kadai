        ...
        <div class="layout-container">
            ...
            <div class="layout-page">
                ...
                <div class="content-wrapper">
                    ...
                    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Daily Report/</span> Daily Report Regist</h4>
                        <div class="row">
                            <div class="col-xl">
                                <div class="card mb-4">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5 class="mb-0">Daily Report Regist Form</h5>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <?php endif; ?>
                                        <form action="http://localhost/gs_code/gs_kadai10/acts/report_regist_act.php" method="post">
                                            <div class="mb-3">
                                                <label class="form-label" for="date">Date</label>
                                                <input type="text" class="form-control" id="date" name="date" required="true" autofocus="true">
                                            ...
                                            <div class="mb-3">
                                                <label class="form-label" for="report">Daily Report</label>
